...
damping_list = [0.2, 0.2, 1., 1., 1.2, 1.2]       # damping ratio
natfreq_list = [1., 2., 1., 2., 1., 2.]                   # nat frequency
...
if 'CONTROL_PLOT_DIR' not in os.environ:
    ...
    plt.savefig(os.environ['CONTROL_PLOT_DIR'] + '/freqdom_tf_step.pdf')
...
if 'CONTROL_PLOT_DIR' not in os.environ:
    ...
    plt.savefig(os.environ['CONTROL_PLOT_DIR'] + '/freqdom_tf_init.pdf')
